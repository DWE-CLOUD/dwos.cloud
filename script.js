...
console.log("Welcome to DwosCloud !")

title = "Hi there, I'm DwosCloud. Welcome to my portfolio !           ";
position = 0;
...
function sendMessage() {
  (function() {
    emailjs.init("Oi5dMcIJSHTu8yzrg");
  })();

  var serviceID = "service_t89a62j";
  var templateID = "template_wf4ragk";
